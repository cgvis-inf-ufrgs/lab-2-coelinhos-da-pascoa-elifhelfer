...
int main(int argc, char *argv[])
{
    ...
    GLFWwindow *window;
    window = glfwCreateWindow(800, 600, "INF01047 - 00577752 - Elias Furtado Helfer", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    {
        bunni_global_angle = (bunni_global_angle > PI * 2.0f) ? 0 : bunni_global_angle + 0.008;
